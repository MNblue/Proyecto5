      ...
      <Card className="cardStyle" style={{ width: '28rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginTop:'300px',marginBottom:'100px' }}>
          ...
          <Card.Body style={{ backgroundColor: '#F5F5F5', marginRight: '10px', marginLeft: '10px', marginBottom: '10px', marginTop: '10px', borderRadius: '8px' }}>
            ...
            <div style={{ textAlign: 'center', marginTop: '20px' }}>
              {editable ? (
                <>
                  <Button className='btn1a' onClick={handleSaveClick}>Guardar</Button>

                </>
              ) : (
                <Button className='btn2a' onClick={handleEditClick} style={{ display: isLogged ? 'inline' : 'none' }}>Editar</Button>
              )}
            </div>
